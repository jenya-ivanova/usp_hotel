...
public class ViewDepartedController {
    @FXML
    private TableView reservations_tableview;
    @FXML
    private Button undo_checkout_button;
    ...
    public void load_reservations(){
        id_reservations = get_departed_reservations();
        id_rooms = get_departed_rooms();
    ...
    public void undo_checkout_button_on_action(ActionEvent event){
        if(reservations_tableview.getSelectionModel().isEmpty()){
            ...
            boolean result = set_undo_checkout(res, room);
            if (result) {
                JOptionPane.showMessageDialog(null, "Checked out removed!");
            ...
            Stage stage = (Stage) undo_checkout_button.getScene().getWindow();
            stage.close();
        }
    }

    public ObservableList<Integer> get_departed_reservations() {
        ObservableList<Integer> options = FXCollections.observableArrayList();

        String getReservations = "SELECT * FROM room_reservation where reservation_status_id=3";
    ...
    public ObservableList<Integer> get_departed_rooms() {
        ObservableList<Integer> options = FXCollections.observableArrayList();

        String getRooms = "SELECT * FROM room_reservation where reservation_status_id=3";
    ...
    public boolean set_undo_checkout(int res, int room) {
        boolean result = false;
        String undoCheckinReservation = "UPDATE room_reservation SET reservation_status_id=2 where reservation_id='" + res + "' AND room_id='" + room + "'";
