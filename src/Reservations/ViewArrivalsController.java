...
public class ViewArrivalsController {
    @FXML
    ...
    public void load_reservations(){
        id_reservations = get_arrival_reservations();
        id_rooms = get_arrival_rooms();
    ...
    public void checkin_button_on_action(ActionEvent event){
        if(reservations_tableview.getSelectionModel().isEmpty()){
            ...
            boolean result = set_checkin(res, room);
            if (result) {
            ...
            Stage stage = (Stage) checkin_button.getScene().getWindow();
            stage.close();
        }
    }
    ...
    public void cancel_button_on_action(ActionEvent event){
        if(reservations_tableview.getSelectionModel().isEmpty()){
            ...
            boolean result = set_cancel(res, room);
            if (result) {
    ...
    public ObservableList<Integer> get_arrival_reservations() {
        ObservableList<Integer> options = FXCollections.observableArrayList();

        String getReservations = "SELECT * FROM room_reservation where reservation_status_id=1";
    ...
    public ObservableList<Integer> get_arrival_rooms() {
        ObservableList<Integer> options = FXCollections.observableArrayList();

        String getRooms = "SELECT * FROM room_reservation where reservation_status_id=1";
    ...
    public boolean set_checkin(int res, int room) {
        boolean result = false;

        String checkinReservation = "UPDATE room_reservation SET reservation_status_id=2 where reservation_id='" + res + "' AND room_id='" + room + "'";

        try {
            if (SQL.updateSQL(checkinReservation))
                result = true;
            else
                result = false;
        } catch (Exception e) {
    ...
    public boolean set_cancel(int res, int room) {
        boolean result = false;
        String cancelReservation = "UPDATE room_reservation SET reservation_status_id=4 where reservation_id='" + res + "' AND room_id='" + room + "'";

        try {
            if (SQL.updateSQL(cancelReservation))
                result = true;
            else
                result = false;
        } catch (Exception e) {
